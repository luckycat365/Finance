...
logic = {'Open'  : 'first',
         ...
         'Close' : 'last',
         'Volume': 'sum'}
df_ohlc=df.resample('W',loffset=offset).apply(logic)
print('origin \n',df.tail(20))
print('after resample \n',df_ohlc.tail())

#df_ohlc.reset_index(inplace=True) # to make the 'Date' to a column
#print(df_ohlc)
...
ax2.fill_between(df_ohlc.index,df_ohlc['Volume'].values, 0)
